...
// Write a packet. Total length : 19 bytes
static void Log_Write_ABC()
{
    struct log_ABC pkt = {
        LOG_PACKET_HEADER_INIT(LOG_ABC_MSG),
        time_ms         : hal.scheduler->millis(),
        abc_vel_cmd     : abc_input[0],
        abc_gam_cmd     : abc_input[1],
        abc_vel         : abc_input[2],
        abc_gam         : abc_input[3],
        abc_thr         : abc_out[0],
        abc_ele         : abc_out[1]
...
static const struct LogStructure log_structure[] PROGMEM = {
    ...
    { LOG_ABC_MSG, sizeof(log_ABC), 
      "ABC",  "Iffffff", "Time,vel_cmd,gam_cmd,vel,gam,thr,ele" },
